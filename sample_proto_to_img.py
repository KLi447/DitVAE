...
batch_size = 16
checkpoint_path = "models/proto_to_img.pt"

d_model = Decoder(512, 1024)
state_dict = torch.load('./models/decoder_earlystop_55.pt', weights_only=True)
...
with torch.no_grad():
    x_init = d_model.sample(text_emb, device=device)
...
plt.tight_layout()
plt.savefig("samples/proto_to_img_generated.png")
plt.close()
print("Saved generated images to samples/proto_to_img_generated.png")