...
def main():
    ...
    final_path = "models/proto_to_img.pt"
    ...
    for i in range(start_iter, iterations):
        ...
        if text_emb.dim() == 3: # :/
            text_emb = text_emb.mean(1)
        # Proto-img
        with torch.no_grad():
            decoded_imgs = d_model.sample(text_emb, device=device)
        ...
        path_sample = path.sample(t=t, x_0=decoded_imgs, x_1=images)
